            ...
            <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
                ...
                <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
                    <div className="mb-10 flex w-[100%] flex-col gap-4 text-center lg:text-left text-[18px] font-medium leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16 lg:max-w-[90%] lg:text-[24px]">
                        <AnimatedBody text={t("about.description1")} />
                        <AnimatedBody text={t("about.description2")} className={"hidden"} />
                        <AnimatedBody text={t("about.description3")} />
                        <AnimatedBody text={t("about.description4")} />
                    </div>
                        ...
                        <div className="flex flex-col gap-4 md:gap-3">
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-2">
                                <img
                                    ...
                                    alt={t("about.languages")}
                                />
                            </div>
                        </div>
                        <div className="flex flex-col gap-3">
                            <AnimatedTitle
                                text={t("about.frameworks")}
                                className={
                                    "text-[24px] text-[#e4ded7] md:text-[30px] lg:text-[20px]"
                                }
                                wordSpace={"mr-[0.25em]"}
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-2">
                                <img
                                    ...
                                    alt={t("about.frameworks")}
                                />
                            </div>
                        </div>
                        <div className="flex flex-col gap-3">
                            <AnimatedTitle
                                text={t("about.databases")}
                                className={
                                    "text-[24px] text-[#e4ded7] md:text-[30px] lg:text-[20px]"
                                }
                                wordSpace={"mr-[0.25em]"}
                ...
                <div className="mt-10 flex flex-col md:-mt-0 lg:mt-28">
                    <SongCarousel />
                    <AnimatedBody
                        text={t("about.songRecommendation")}
